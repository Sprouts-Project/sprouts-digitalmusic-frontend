...
(function () {
  ...
  angular.module('BlurAdmin.pages.financePanel')
      .controller('SalesValuePredictionsByStateCtrl', SalesValuePredictionsByStateCtrl);

  /** @ngInject */
  function SalesValuePredictionsByStateCtrl($scope, $http, orderByFilter, baConfig, layoutPaths) {
    ...
    $http.get('/dashboard/sales-value-predictions-by-state').then(function(response) {
